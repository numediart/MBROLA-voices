...
1.0 A brief description of the FR4 database
2.0 Distribution
3.0 Installation, and tests
4.0 Author

--------------------------------------------------------------
1.0 A brief description of FR4
--------------------------------------------------------------

FR4 2.069 release is a French diphone database provided in the context
...
Copy fr4.zip into the mbrola directory and unzip it : 

   unzip fr4.zip (or pkunzip on PC/DOS)
   (don't forget to delete the .zip file when this is done)

On PC-Windows register fr4 with the Wizard in the control panel.

On unix platforms, try:

   mbrola fr4 TEST/bonjour.pho bonjour.wav
...
a HP : mbrola fr4 TEST/bonjour.pho - | splayer -srate 16000 -l16 
...
This  database  was recorded by Babel Technologies SA - Belgium.
