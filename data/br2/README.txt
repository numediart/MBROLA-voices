...
1.0 A brief description of the BR2 database
2.0 Distribution
3.0 Installation, and tests
4.0 Acknowledgments

--------------------------------------------------------------
1.0 A brief description of BR2
--------------------------------------------------------------
BR2 is a Brazilian Portuguese diphone database provided in the
...
Copy br2.zip into the mbrola directory and unzip it : 

   unzip br2.zip (or pkunzip on PC/DOS)
   (don't forget to delete the .zip file when this is done)

Try 

   mbrola br2 TEST/1.pho 1.wav
